...
2),this.value2.updateBind());this.draw()};this.RangeSlider.prototype.mouseUp=function(){this.value1.updateBind(!0);this.value2.updateBind(!0)};this.DropDown=function(a){Base.call(this,a);this.name="DropDown";this.values=a.values||["DropDown"];this.texts=a.texts||this.values;this.dropdown=document.createElement("select");this.dropdown.setAttribute("id",this.id);this.value=new Value(this.values[0]);for(a=0;a<this.values.length;++a){var c=document.createElement("option");c.text=this.texts[a];c.value=
this.values[a];this.dropdown.options.add(c)}a=document.createElement("canvas");a.width=16;a.height=16;c=a.getContext("2d");c.clearRect(0,0,16,16);c.fillStyle=l;c.fillRect(0,0,16,16);c.fillStyle=f;c.beginPath();c.moveTo(4.5,6);c.lineTo(12.5,6);c.lineTo(8.5,11);c.lineTo(4.5,6);c.closePath();c.fill();c.strokeStyle=e;c.beginPath();c.moveTo(0,0);c.lineTo(0,16);c.closePath();c.stroke();c.beginPath();c.moveTo(16,0);c.lineTo(16,16);c.closePath();c.stroke();this.div=document.createElement("div");this.div.setAttribute("id",
...
e;g.appendChild(this.div);this.div.appendChild(this.dropdown);this.dropdown.onchange=this.onChange;this.dropdown.onfocus=this.onFocus;this.draw()};this.DropDown.prototype=new Base;this.DropDown.prototype.constructor=this.DropDown;this.DropDown.prototype.onChange=function(){var a=h[this.id];a.value.v=this.value;a.value.updateBind()};this.DropDown.prototype.onFocus=function(){i=this.id};this.DropDown.prototype.draw=function(){};this.DropDown.prototype.mouseDown=function(){};this.DropDown.prototype.mouseUp=
...
(this.value.v+Math.abs(this.min));a.fillRect(this.x+this.width-1,this.y+this.height-b,1,b);a.restore()};this.Graph.prototype.mouseDown=function(){};this.Graph.prototype.mouseUp=function(){};this.ImageButton=function(a){Base.call(this,a);this.name="ImageButton";this.image=a.image||new Image;this.width=this.image.width;this.height=this.image.height;this.mouseIsDown=!1;this.value=new Value(this.mouseIsDown);this.draw()};this.ImageButton.prototype=new Base;this.ImageButton.prototype.constructor=this.ImageButton;
this.ImageButton.prototype.draw=function(){a.clearRect(this.x,this.y,this.width,this.height);a.globalAlpha=this.mouseIsDown?0.5:1;a.drawImage(this.image,this.x,this.y);a.globalAlpha=1};this.ImageButton.prototype.mouseDown=function(){this.mouseIsDown=!0;this.value.v=this.mouseIsDown;this.value.updateBind();this.draw()};this.ImageButton.prototype.mouseUp=function(){this.value.updateBind(!0);this.mouseIsDown=!1;this.value.v=this.mouseIsDown;this.value.updateBind();this.draw()};this.Button=function(a){Base.call(this,
a);this.name="Button";this.width=this.fullWidth=0;this.height=Math.max(a.height,14)||14;this.text=a.text||"";this.mouseIsDown=!1;this.value=new Value(this.mouseIsDown);this.draw();this.draw()};this.Button.prototype=new Base;this.Button.prototype.constructor=this.Button;this.Button.prototype.draw=function(){a.clearRect(this.x,this.y,this.width,this.height);a.strokeStyle=e;a.lineWidth=2;a.strokeRect(this.x,this.y,this.width,this.height);a.fillStyle=f;this.mouseIsDown&&(a.fillStyle=l);a.fillRect(this.x,
this.y,this.width,this.height);var b=Math.round(0.5*Math.max(0,this.height-14));a.fillStyle=e;this.mouseIsDown&&(a.fillStyle=f);a.font="11px Arial";a.textBaseline="alphabetic";a.textAlign="left";a.fillText(this.text,this.x+4,this.y+11+b);this.width=this.fullWidth+a.measureText(this.text).width+9};this.Button.prototype.mouseDown=function(){this.mouseIsDown=!0;this.value.v=this.mouseIsDown;this.value.updateBind();this.draw()};this.Button.prototype.mouseUp=function(){this.value.updateBind(!0);this.mouseIsDown=
!1;this.value.v=this.mouseIsDown;this.draw()};this.TrackPad=function(a){Base.call(this,a);this.name="TrackPad";this.width=a.width||100;this.height=a.height||60;this.min=a.min||-1;this.max=a.max||1;this.range=this.max-this.min;var c=-1*(this.range/2-this.max);this.value1=new Value(a.value1||c);this.value2=new Value(a.value2||c);this.draw()};this.TrackPad.prototype=new Base;this.TrackPad.prototype.constructor=this.TrackPad;this.TrackPad.prototype.draw=function(){this.value1.v<this.min&&(this.value1.v=
this.min);this.value1.v>this.max&&(this.value1.v=this.max);this.value2.v<this.min&&(this.value2.v=this.min);this.value2.v>this.max&&(this.value2.v=this.max);a.clearRect(this.x-1,this.y,this.width,this.height+14);a.strokeStyle=e;a.lineWidth=2;a.strokeRect(this.x,this.y,this.width,this.height);a.fillStyle=f;a.fillRect(this.x,this.y,this.width,this.height);a.strokeStyle=l;a.lineWidth=1;a.beginPath();a.moveTo(this.x,0.5+this.y+this.height/2);a.lineTo(this.x+this.width,0.5+this.y+this.height/2);a.closePath();
a.stroke();a.beginPath();a.moveTo(0.5+this.x+this.width/2,this.y);a.lineTo(0.5+this.x+this.width/2,this.y+this.height);a.closePath();a.stroke();var b=this.getXPositionFromValue(),c=this.getYPositionFromValue();3>b&&(b=3);b>this.width-3&&(b=this.width-3);3>c&&(c=3);c>this.height-3&&(c=this.height-3);a.fillStyle=l;a.fillRect(this.x+b-3,this.y+c-3,7,7);a.fillStyle=e;a.font="8px Arial";a.textBaseline="alphabetic";a.textAlign="left";a.fillText("X: "+this.value1.v.toFixed(2)+" Y: "+this.value2.v.toFixed(2),
this.x,this.y+this.height+9)};this.TrackPad.prototype.setXValueFromPosition=function(a){this.value1.v=this.range/this.width*a-(this.range-this.max)};this.TrackPad.prototype.setYValueFromPosition=function(a){this.value2.v=this.range/this.height*a-(this.range-this.max)};this.TrackPad.prototype.getXPositionFromValue=function(){var a=this.width/this.range,c=Math.abs(this.min);0<this.min&&(c*=-1);return a*(this.value1.v+c)};this.TrackPad.prototype.getYPositionFromValue=function(){var a=this.height/this.range,
...
100;this.colorheight=a.height||30;this.width=this.framewidth;this.height=this.frameheight;this.r=a.r||255;this.g=a.g||255;this.b=a.b||255;this.oldColor={r:this.r,g:this.g,b:this.b};this.mousehack=this.open=!1;this.lastTime=0;this.hex=a.hex||colorToHex("rgb("+this.r+","+this.g+","+this.b+")");this.value=new Value(this.hex);this.draw()};this.ColorPicker2.prototype=new Base;this.ColorPicker2.prototype.constructor=this.ColorPicker2;this.ColorPicker2.prototype.draw=function(){a.clearRect(this.x-1,this.y-
...
this.r+","+this.g+","+this.b+")");this.value.v=this.hex;this.value.updateBind();this.draw()};this.ColorPicker.prototype.mouseUp=function(){this.value.updateBind(!0)};this.Knob=function(a){Base.call(this,a);this.name="Knob";this.radius=a.radius||15;this.centerx=this.x+this.radius;this.centery=this.y+this.radius;this.width=2*this.radius;this.height=2*this.radius;this.min=a.min||0;this.max=a.max||100;this.range=this.max-this.min;this.value=new Value(a.value||0);this.rotationValue=this.getRotationValue();
this.lastMouseY=this.lastMouseX=null;this.decimals=a.decimals||0;this.draw()};this.Knob.prototype=new Base;this.Knob.prototype.constructor=this.Knob;this.Knob.prototype.getRotationValue=function(){return(this.value.v-this.min)*(1/this.range)};this.Knob.prototype.draw=function(){this.value.v<this.min&&(this.value.v=this.min);this.value.v>this.max&&(this.value.v=this.max);a.clearRect(this.x-4,this.y-4,this.width+8,this.height+13);a.fillStyle=e;a.beginPath();a.arc(this.centerx,this.centery,this.radius,
0,2*Math.PI,!1);a.closePath();a.fill();var b=Math.PI+Math.PI/1.25,c=Math.PI-Math.PI/1.25,d=(b-c)/this.radius;a.strokeStyle=e;a.lineWidth=0.5;for(var g=0;g<=this.radius;++g){var h=this.centerx+Math.sin(b-d*g)*(this.radius+1),i=this.centery+Math.cos(b-d*g)*(this.radius+1),j=this.centerx+Math.sin(b-d*g)*(this.radius+4),k=this.centery+Math.cos(b-d*g)*(this.radius+4);a.beginPath();a.moveTo(h,i);a.lineTo(j,k);a.closePath();a.stroke()}this.rotationValue=this.getRotationValue();d=(b-c)*this.rotationValue;
c=this.centerx+Math.sin(b-d)*this.radius;b=this.centery+Math.cos(b-d)*this.radius;a.strokeStyle=f;a.lineWidth=2;a.beginPath();a.moveTo(this.centerx,this.centery);a.lineTo(c,b);a.closePath();a.stroke();a.fillStyle=e;a.font="8px Arial";a.textBaseline="alphabetic";a.textAlign="center";a.fillText(this.value.v.toFixed(this.decimals),this.centerx,this.centery+this.radius+7)};this.Knob.prototype.mouseDown=function(a,c){if(null!=this.lastMouseX){var d=(a-this.lastMouseX-(c-this.lastMouseY))/100,d=d*this.range;
this.value.v+=d;this.draw();this.value.updateBind()}this.lastMouseX=a;this.lastMouseY=c};this.Knob.prototype.mouseUp=function(){this.lastMouseY=this.lastMouseX=null;this.value.updateBind(!0)};this.CheckBox=function(a){Base.call(this,a);this.name="CheckBox";this.text=a.text||"";this.value=new Value(a.selected||!1);this.width=this.fullWidth=a.width||10;this.height=a.height||10;this.draw()};this.CheckBox.prototype=new Base;this.CheckBox.prototype.constructor=this.CheckBox;this.CheckBox.prototype.draw=
...
function(a){Base.call(this,a);this.name="Label";this.group=null;this.value=new Value(a.text||"");this.width=0;this.height=13;this.draw()};this.Label.prototype=new Base;this.Label.prototype.constructor=this.Label;this.Label.prototype.draw=function(){a.clearRect(this.x,this.y,this.width,this.height);a.fillStyle=e;a.font="11px Arial";a.textBaseline="alphabetic";a.textAlign="left";a.fillText(this.value.v,this.x,this.y+9);this.width=a.measureText(this.value.v).width+3};this.Label.prototype.mouseDown=function(){};
this.Label.prototype.mouseUp=function(){};this.update=function(){m=Date.now();for(var a=0;a<h.length;++a){var c=h[a];if(c.value&&(c.value.receiver||c.value.both)&&m>c.lastUpdate+c.updateInterval)c.value.updateBind(),c.draw(),c.lastUpdate=m;if(c.value1){var d=!1;if((c.value1.receiver||c.value1.both)&&m>c.lastUpdate+c.updateInterval)c.value1.updateBind(),d=!0;if((c.value2.receiver||c.value2.both)&&m>c.lastUpdate+c.updateInterval)c.value2.updateBind(),d=!0;d&&(c.draw(),c.lastUpdate=m)}}};return{getDomElement:function(){return g},
